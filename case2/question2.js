...
// Pesan yang ingin Anda tulis ke dalam file log.txt
const logFile = `
...
// Menulis pesan ke dalam file log.txt
fs.writeFile("./log.txt", logFile + "\n", (err) => {
  if (err) {
    console.error("Terdapat kesalahan saat menulis logFile", err);
  } else {
    console.log("logFile berhasil ditulis ke dalam file log.txt");
  }
});
